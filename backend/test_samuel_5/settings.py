"""
Django settings for test_samuel_5 project.
...
ROOT_URLCONF = 'test_samuel_5.urls'
...
WSGI_APPLICATION = 'test_samuel_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_samuel_5 API",
    "DESCRIPTION": "API documentation for test_samuel_5 App",
    "VERSION": "v1",
}
